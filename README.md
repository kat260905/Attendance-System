...
- **Quick Mark by Register Number**: Mark attendance by entering last 3 digits of register numbers
...
- **Date-wise Session View**: Sessions organized by date with collapsible sections
- **Photo Attendance**: Upload class photos for attendance marking
...
4. **Quick Mark by Register Number**:
   - Enter the last 3 digits of register numbers (e.g., 135, 042, or 7)
   - Separate multiple entries with commas or spaces
   - Choose to mark as "Present" or "Absent"
   - Click the mark button to apply
...
- `POST /api/attendance/mark-by-suffix` - Mark attendance by register number suffix (last 3 digits)
